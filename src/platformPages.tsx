...
function SchedulersPage() {
  ...
  const visible = items.filter((item) => `${item.name} ${item.workflowName} ${item.cronExpression} ${item.timezone}`.toLowerCase().includes(query.toLowerCase()))
