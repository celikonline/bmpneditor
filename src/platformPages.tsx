...
function ExecutionsPage() {
  ...
  const visible = useMemo(() => records.filter((record) => {
    ...
    return matchesText && matchesWorkflow && matchesCorrelation && matchesExecutionName && (status === 'ALL' || record.status === status) && matchesAfter && matchesBefore
  }), [correlationFilter, executionNameFilter, query, records, startedAfter, startedBefore, status, workflowFilter])
