...
export const quickAddCatalog: TaskCatalogItem[] = [
  ...
  { name: 'Chat Completion', desc: 'Generate a chat response.', group: 'Agentic Orchestration', kind: 'LLM_CHAT_COMPLETE', icon: Bot },
  { name: 'Generate Embedding', desc: 'Generate an embedding.', group: 'Agentic Orchestration', kind: 'LLM_GENERATE_EMBEDDINGS', icon: Code2 },
  { name: 'Search Embedding', desc: 'Search an embedding index.', group: 'Agentic Orchestration', kind: 'LLM_SEARCH_EMBEDDINGS', icon: Search },
  { name: 'Index Document', desc: 'Index a document.', group: 'Agentic Orchestration', kind: 'LLM_INDEX_DOCUMENT', icon: FileStack },
  { name: 'Search Document', desc: 'Search indexed documents.', group: 'Agentic Orchestration', kind: 'LLM_SEARCH_INDEX', icon: FileSearch },
  { name: 'Agent', desc: 'Invoke an agent.', group: 'Agentic Orchestration', kind: 'AGENT', icon: Paperclip },
  { name: 'Get Agent', desc: 'Retrieve an agent.', group: 'Agentic Orchestration', kind: 'GET_AGENT_CARD', icon: Paperclip },
  { name: 'Cancel Agent', desc: 'Cancel an agent run.', group: 'Agentic Orchestration', kind: 'CANCEL_AGENT', icon: X },
  { name: 'List MCP Tools', desc: 'List available MCP tools.', group: 'Agentic Orchestration', kind: 'LIST_MCP_TOOLS', icon: Paperclip },
  { name: 'Call MCP Tool', desc: 'Call an MCP tool.', group: 'Agentic Orchestration', kind: 'CALL_MCP_TOOL', icon: Paperclip },
